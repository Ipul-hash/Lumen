...
@section('content')
<div class="bg-light py-5 border-bottom text-center">
    <div class="container px-lg-5">
        <span class="badge bg-dark text-white text-uppercase tracking-wider px-3 py-2 mb-2 fw-bold fs-8">Real-Time Logistics Tracking</span>
        <h1 class="display-6 font-serif fw-bold text-dark mb-2">Lacak Status Paket & Resi Pengiriman</h1>
        <p class="text-muted fs-7 mx-auto mb-4" style="max-width: 600px;">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <form action="{{ route('shop.track') }}" method="GET" class="input-group input-group-lg shadow-sm">
                    <input type="text" name="q" class="form-control rounded-0 fs-7" placeholder="Nomor Pesanan / Nomor Resi..." value="{{ request('q') }}" required>
                    <button class="btn btn-dark rounded-0 px-4 fs-7 fw-bold" type="submit">
                ...
                <div class="col-lg-8">
                    <div class="card border rounded-0 shadow-sm mb-4">
                        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                            ...
                            <span class="badge bg-primary text-white fs-7 px-3 py-2 fw-bold">
                                    ...
                                    @foreach($trackingCheckpoints as $index => $cp)
                                        <div class="position-relative mb-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                <span class="badge {{ $index === 0 ? 'bg-light-primary text-primary border border-primary' : 'bg-light text-secondary border' }} fs-8 fw-bold">
                                                    {{ $cp['status'] ?? 'UPDATE' }}
                                                </span>
        ...
        @else
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center py-5">
                    ...
                    <a href="{{ route('shop.track') }}" class="btn btn-outline-dark btn-sm rounded-0 px-3">Coba Lagi</a>
                </div>
            </div>
        @endif
    @else
                ...
                <div class="row g-4 text-center">
                    <div class="col-md-4">
                        <div class="p-4 border bg-white h-100">
                            <i class="bi bi-box-seam fs-2 text-dark mb-2 d-block"></i>
                            <h6 class="fw-bold fs-7 text-uppercase">1. Otomasi Booking</h6>
                            <p class="fs-8 text-muted mb-0">Setiap order yang lunas langsung membuat booking ID pada sistem KiriminAja.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-4 border bg-white h-100">
                            <i class="bi bi-upc-scan fs-2 text-dark mb-2 d-block"></i>
                            <h6 class="fw-bold fs-7 text-uppercase">2. Auto-AWB Resi</h6>
                            <p class="fs-8 text-muted mb-0">Nomor resi kurir diterbitkan otomatis dan langsung ditempel pada label thermal A6.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-4 border bg-white h-100">
                            <i class="bi bi-truck fs-2 text-dark mb-2 d-block"></i>
                            <h6 class="fw-bold fs-7 text-uppercase">3. Kurir Pickup</h6>
                            <p class="fs-8 text-muted mb-0">Kurir J&T, SiCepat, atau JNE menjemput paket langsung dari warehouse.</p>
                        </div>
                    </div>
                </div>
            </div>
